...
import { LocalGuestNameService } from "./infra/LocalGuestNameService";
...
container.bind(LocalGuestNameService).toSelf().inSingletonScope()
container.bind(GuestNameService).to(LocalGuestNameService)
